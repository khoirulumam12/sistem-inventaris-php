...
<head>
    ...
    <title>Request Barang - Toko Cahaya Subur</title>
...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="request.php"><div class="sb-nav-link-icon"><i class="fas fa-clipboard-list"></i></div> Request Barang</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4 mb-4 text-gray-800">Request Barang</h1>

                    <?php if(isset($_GET['status'])): ?>
                        <?php if($_GET['status'] == 'success'): ?>
                            <div class="alert alert-success alert-dismissible fade show shadow-sm" role="alert">
                                <strong>Berhasil!</strong> Permintaan barang telah disimpan.
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                            </div>
                        <?php elseif($_GET['status'] == 'gagal_stok_kurang'): ?>
                            <div class="alert alert-danger alert-dismissible fade show shadow-sm" role="alert">
                                <strong>Gagal!</strong> Stok barang tidak mencukupi.
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                            </div>
                        <?php else: ?>
                            <div class="alert alert-danger alert-dismissible fade show shadow-sm" role="alert">
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-clipboard-list mr-1"></i> Daftar Permintaan</h6>
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                // PERUBAHAN: ORDER BY r.idrequest ASC (Lama di atas, Baru di bawah)
                                $ambilsemuadatastok = mysqli_query($conn, "SELECT r.*, s.namabarang, s.image FROM requestbarang r JOIN stok s ON s.idbarang = r.idbarang ORDER BY r.idrequest ASC");
                                $data_request_array = [];
                                while($row = mysqli_fetch_array($ambilsemuadatastok)){
                                    $data_request_array[] = $row;
                                }
                            ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach($data_request_array as $data):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#edit<?=$idrequest;?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm btn-rounded" data-toggle="modal" data-target="#delete<?=$idrequest;?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Request Barang</h4>
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <select name="barangnya" class="form-control mb-3" required>
                            ...
                            ?>
                            <option value="<?=$idbarangnya;?>"><?=$namabarangnya;?> (Stok: <?=$stoknya;?>)</option>
                            <?php } ?>
                        </select>
                        <label>Jumlah</label>
                        <input type="number" name="qty" placeholder="Quantity" class="form-control mb-3" required min="1">
                        <label>Penerima (Divisi/Nama)</label>
                        <input type="text" name="penerima" placeholder="Contoh: Divisi Gudang" class="form-control mb-3" required>
                        <label>Keterangan</label>
                        <input type="text" name="keterangan" placeholder="Keperluan..." class="form-control mb-3" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary" name="addrequest">Submit</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="edit<?=$idrequest;?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary" name="updaterequest">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="delete<?=$idrequest;?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form method="post">
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>Apakah Anda yakin ingin menghapus request:</p>
                            <h5 class="font-weight-bold"><?=$namabarang;?></h5>
                            <p>Sejumlah: <b><?=$qty;?></b></p>
                            <p class="small text-success">Stok akan dikembalikan (bertambah).</p>
