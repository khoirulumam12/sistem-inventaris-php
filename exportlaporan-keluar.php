...
<head>
    ...
    <title>Laporan Barang Keluar - Toko Cahaya Subur</title>
            ...
            <main>
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-4 mt-4">
                        <h1 class="h3 mb-0 text-gray-800">Export Barang Keluar</h1>
                        <a href="keluar.php" class="btn btn-sm btn-secondary shadow-sm btn-rounded">
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-file-export mr-1"></i> Laporan Riwayat Barang Keluar</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="mauexport" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        // DIUBAH MENJADI ASC (ASCENDING) BERDASARKAN ID KELUAR
                                        $ambilsemuadatastok = mysqli_query($conn, "SELECT * FROM keluar k, stok s WHERE s.idbarang = k.idbarang ORDER BY k.idkeluar ASC");
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-warning text-white"><?php echo $qty; ?></span></td>
