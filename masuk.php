...
<head>
    ...
    <title>Barang Masuk - Toko Cahaya Subur</title>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="masuk.php"><div class="sb-nav-link-icon"><i class="fas fa-arrow-circle-down"></i></div> Barang Masuk</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4 mb-4 text-gray-800">Barang Masuk</h1>

                    <?php if(isset($_GET['status'])): ?>
                        <?php if($_GET['status'] == 'success'): ?>
                            <div class="alert alert-success alert-dismissible fade show shadow-sm" role="alert">
                                <strong>Berhasil!</strong> Data barang masuk telah ditambahkan.
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table mr-1"></i> Riwayat Pemasukan</h6>
                            <div>
                                ...
                                <a href="exportmasuk.php" class="btn btn-success btn-sm btn-rounded shadow-sm">
                                    <i class="fas fa-file-excel"></i> Export
                                </a>
                                <a href="exportlaporan-masuk.php" class="btn btn-warning btn-sm btn-rounded shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="form-inline mb-4">
                                ...
                                <a href="masuk.php" class="btn btn-secondary ml-2">Reset</a>
                            </form>
                            
                            <?php
                                // PERUBAHAN DISINI: ORDER BY idmasuk ASC (Input baru di bawah)
                                if(isset($_POST['filter_tgl'])){
                                    $mulai = $_POST['tgl_mulai'];
                                    $selesai = $_POST['tgl_selesai'];
                                    
                                    if($mulai!=null || $selesai!=null){
                                        $ambilsemuadatastok = mysqli_query($conn, "SELECT m.*, s.namabarang, s.image, s.kode_barang, s.harga FROM masuk m JOIN stok s ON s.idbarang = m.idbarang WHERE DATE(m.tanggal) BETWEEN '$mulai' AND '$selesai' ORDER BY m.idmasuk ASC");
                                    } else {
                                        $ambilsemuadatastok = mysqli_query($conn, "SELECT m.*, s.namabarang, s.image, s.kode_barang, s.harga FROM masuk m JOIN stok s ON s.idbarang = m.idbarang ORDER BY m.idmasuk ASC");
                                    }
                                } else {
                                    $ambilsemuadatastok = mysqli_query($conn, "SELECT m.*, s.namabarang, s.image, s.kode_barang, s.harga FROM masuk m JOIN stok s ON s.idbarang = m.idbarang ORDER BY m.idmasuk ASC");
                                }
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach($data_masuk_array as $data):
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$keterangan;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#edit<?=$idmasuk;?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm btn-rounded" data-toggle="modal" data-target="#delete<?=$idmasuk;?>">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <select name="barangnya" class="form-control mb-3" required>
                            ...
                            ?>
                            <option value="<?=$idbarangnya;?>">[<?=$kodenya;?>] <?=$namabarangnya;?> - <?=$harganya;?></option>
                            <?php } ?>
                        </select>
                        <label>Jumlah</label>
                        <input type="number" name="qty" placeholder="Quantity" class="form-control mb-3" required min="1">
                        <label>Keterangan</label>
                        <input type="text" name="keterangan" placeholder="Keterangan / Supplier" class="form-control mb-3" required>
                    </div>
                ...
                <form method="post">
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>Apakah Anda yakin ingin menghapus data masuk:</p>
                            <h5 class="font-weight-bold"><?=$namabarang;?></h5>
                            <p>Sejumlah: <b><?=$qty;?></b></p>
                            <p class="small text-danger">Stok akan otomatis berkurang kembali.</p>
