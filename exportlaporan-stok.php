...
<head>
    ...
    <title>Laporan Stok Barang - Toko Cahaya Subur</title>
    ...
    <style>
        ...
        /* IMAGE STYLING */
        .zoomable { width: 60px; height: 60px; object-fit: cover; border-radius: 6px; transition: all 0.3s; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
        .zoomable:hover { transform: scale(2.5); z-index: 999; position: relative; border: 2px solid #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.3); }
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-file-alt mr-1"></i> Data Seluruh Stok Gudang</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="mauexport" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        // MENGUBAH URUTAN MENJADI ASC BERDASARKAN IDBARANG
                                        ...
                                        while($data = mysqli_fetch_array($ambilsemuadatastok)){
                                            ...
                                            if ($gambar == null || $gambar == '' || $gambar == 'No Photo') {
                                                $image = '<span class="text-muted small">No Img</span>';
                                            } else {
                                                $image = '<img src="images/'.$gambar.'" class="zoomable" alt="Img">';
                                            }
                                        ?>
                                        <tr>
                                            <td class="text-center"><?php echo $i++; ?></td>
                                            <td class="text-center"><?php echo $image; ?></td>
                                            <td style="font-weight: 500;"><?php echo $namabarang; ?></td>
                                            <td><?php echo $deskripsi; ?></td>
                                            <td class="text-center">
                                                <?php if($stok <= 5): ?>
                                                    <span class="badge badge-danger px-3 py-2">
                                                        <?php echo $stok; ?> (Kritis)
                                                    </span>
                                                <?php else: ?>
